package com.ljj.pay.modules.alipay.service.impl;
...
import com.ljj.pay.modules.alipay.service.IAliPayService;
import com.ljj.pay.modules.alipay.util.AliPayConfig;
...
public class IAliPayServiceImpl implements IAliPayService {
    private static final Logger logger = LoggerFactory.getLogger(IAliPayServiceImpl.class);
